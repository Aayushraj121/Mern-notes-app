      ...
      <QueryClientProvider client={queryClient}>
        ...
        <Switch>
          ...
          <Route path="/notes/new">
            <ProtectedRoute component={CreateNote} />
          </Route>
